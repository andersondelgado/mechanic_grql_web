...
import FacturaModal from "../components/modales/FacturaModal";

export default function Facturas() {
  const [page, setPage] = useState(1);
  const { data, meta, loading, error, remove, refetch } = useGrqlList<any[]>("GestionTallerProd_customer_account_statements", {
  ...
  const handleOpenEdit = (factura: any) => {
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="border-b border-gray-100 bg-gray-50/70 text-gray-500 font-bold uppercase text-[11px] tracking-wider">
                  ...
                  <th className="py-4 px-6 text-left">Crédito (Abonado)</th>
